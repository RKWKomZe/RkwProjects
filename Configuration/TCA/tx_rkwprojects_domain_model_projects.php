	...
	'columns' => [
		...
		'project_staff' => [
			...
			'config' => [
                ...
                'foreign_table_where' => 'AND tx_rkwauthors_domain_model_authors.sys_language_uid = ###REC_FIELD_sys_language_uid### ORDER BY last_name ASC',
		...
		'project_manager' => [
			...
			'config' => [
				...
				'renderType' => 'selectSingle',
				'foreign_table' => 'tx_rkwauthors_domain_model_authors',
                'foreign_table_where' => 'AND ((\'###PAGE_TSCONFIG_IDLIST###\' <> \'0\' AND FIND_IN_SET(tx_rkwauthors_domain_model_authors.pid,\'###PAGE_TSCONFIG_IDLIST###\')) OR (\'###PAGE_TSCONFIG_IDLIST###\' = \'0\')) AND tx_rkwauthors_domain_model_authors.sys_language_uid = ###REC_FIELD_sys_language_uid### AND tx_rkwauthors_domain_model_authors.internal = 1 ORDER BY tx_rkwauthors_domain_model_authors.last_name ASC',
                # 'foreign_table_where' => 'AND tx_rkwauthors_domain_model_authors.sys_language_uid = ###REC_FIELD_sys_language_uid### ORDER BY last_name ASC',
				'maxitems' => 1,
                'minitems' => 1,
                'items' => [
		...
		'sys_category' => [
			...
			'config' => [
                ...
                'foreign_table_where' => 'AND ((\'###PAGE_TSCONFIG_IDLIST###\' <> \'0\' AND FIND_IN_SET(tx_rkwauthors_domain_model_authors.pid,\'###PAGE_TSCONFIG_IDLIST###\')) OR (\'###PAGE_TSCONFIG_IDLIST###\' = \'0\')) AND tx_rkwauthors_domain_model_authors.sys_language_uid = ###REC_FIELD_sys_language_uid### AND tx_rkwauthors_domain_model_authors.internal = 1 ORDER BY tx_rkwauthors_domain_model_authors.last_name ASC',
                # 'foreign_table_where' => 'AND tx_rkwprojects_domain_model_projects.sys_language_uid = ###REC_FIELD_sys_language_uid### ORDER BY title ASC',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
